...
CREATE TABLE `cms_browse_log` (
  ...
  `category_name` varchar(100) DEFAULT NULL COMMENT '??????',
  `ip` varchar(50) DEFAULT NULL COMMENT 'IP地址',
  `duration_seconds` int DEFAULT NULL COMMENT '???????',
  `user_agent` varchar(500) DEFAULT NULL COMMENT 'User-Agent',
  `leave_time` datetime DEFAULT NULL COMMENT '????',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '浏览时间',
  PRIMARY KEY (`id`),
  KEY `idx_user_id` (`user_id`),
  KEY `idx_product_id` (`product_id`),
  KEY `idx_create_time` (`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='浏览日志表';
...
INSERT INTO `cms_browse_log` VALUES (1,9,'customer01',214,'Apple iPhone 15 Pro Max',1,'手机数码','0:0:0:0:0:0:0:1',12,'Mozilla/5.0 (Windows NT; Windows NT 10.0; zh-CN) WindowsPowerShell/5.1.26100.8115','2026-05-31 14:14:56','2026-05-31 14:14:56');
...
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='购物车表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `oms_cart` VALUES (18,3,215,2,'2025-12-31 17:40:03','2025-12-31 17:40:03'),(19,3,214,3,'2026-01-01 05:43:53','2026-01-01 05:43:53');
...
CREATE TABLE `pms_product` (
  ...
  KEY `idx_status` (`status`)
) ENGINE=InnoDB AUTO_INCREMENT=275 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='商品表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_login_log` (
  ...
  `user_agent` varchar(500) DEFAULT NULL COMMENT 'User-Agent',
  `success` tinyint NOT NULL DEFAULT '1' COMMENT '?????0???1??',
...
INSERT INTO `sys_login_log` VALUES (1,1,'admin','ADMIN','2026-05-31 14:14:44','0:0:0:0:0:0:0:1','Mozilla/5.0 (Windows NT; Windows NT 10.0; zh-CN) WindowsPowerShell/5.1.26100.8115',1,'登录成功','2026-05-31 14:14:44'),(2,9,'customer01','CUSTOMER','2026-05-31 14:14:56','0:0:0:0:0:0:0:1','Mozilla/5.0 (Windows NT; Windows NT 10.0; zh-CN) WindowsPowerShell/5.1.26100.8115',1,'登录成功','2026-05-31 14:14:56');
...
CREATE TABLE `sys_operation_log` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '??',
  `admin_id` bigint DEFAULT NULL COMMENT '????ID',
  `username` varchar(64) NOT NULL COMMENT '????',
  `role` varchar(20) NOT NULL COMMENT '??',
  `operation_type` varchar(50) NOT NULL COMMENT '????',
  `operation_content` varchar(500) NOT NULL COMMENT '????',
  `request_uri` varchar(255) DEFAULT NULL COMMENT '????',
  `ip` varchar(64) DEFAULT NULL COMMENT 'IP??',
  `create_time` datetime NOT NULL COMMENT '????',
  PRIMARY KEY (`id`),
  KEY `idx_username` (`username`),
...
CREATE TABLE `ums_admin` (
  ...
  `role` varchar(20) NOT NULL DEFAULT 'CUSTOMER' COMMENT '???CUSTOMER/SALES/ADMIN',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_username` (`username`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='后台用户表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ums_admin` VALUES (1,'admin','$2b$10$qXmWuDDAMk6PpnXoF97Ay.NtB7IEqRxSwG09uChneBP2fPc36.oGu',NULL,NULL,'超级管理员',NULL,'2025-12-28 04:03:30','2026-05-31 14:14:44',1,'ADMIN'),(2,'testuser','$2a$10$61DHTa6ouzxVsO8QDVK2OOfblBY70SLFu99.QhcZuz8PcRYT.dKSC',NULL,'test@example.com','测试用户',NULL,'2025-12-28 15:22:53','2025-12-28 15:43:17',1,'CUSTOMER'),(3,'111','$2a$10$tQ9DGPxi3jXrD4t6DTvqsujgfILO1hbZ.Am9MGEP9j267yHTACnfG',NULL,'123@qq.com','111',NULL,'2025-12-28 16:13:44','2026-01-01 05:47:29',1,'CUSTOMER'),(4,'123456','$2a$10$4cbB1FM0oCSqnp9ZtPLatuOz19HVYA5JNDIcn0uozJemkcujgx7K6',NULL,'123@qq.com','123456',NULL,'2025-12-28 22:03:47','2025-12-28 22:18:11',1,'CUSTOMER'),(7,'1111','$2a$10$eQTfhGhRTs.hX9N2qLWJWuqUQQVEcq9Qg1Vbv/NFBmorMB08QW.lC',NULL,'2264575523@qq.com','test1',NULL,'2025-12-28 22:57:55','2025-12-28 22:58:01',1,'CUSTOMER'),(8,'sales01','$2b$10$B/70FMvQ.6sdahHUcNahFuiXKmevkjvXFGBDGu3eVcaOXF6mzy5uG',NULL,'sales01@example.com','????01','??????????','2026-05-31 14:13:17',NULL,1,'SALES'),(9,'customer01','$2b$10$B/70FMvQ.6sdahHUcNahFuiXKmevkjvXFGBDGu3eVcaOXF6mzy5uG',NULL,'customer01@example.com','????01','????????','2026-05-31 14:13:17','2026-05-31 14:14:56',1,'CUSTOMER');
...
--
-- Dumping routines for database 'emart'
--
...
-- Dump completed on 2026-05-31 14:16:05
